...
//	}
	...
	return this.getMeasureDefinition().getMeasureName();
	}
	
//	public String setMeasure(String measure) {
//	return this.getMeasureDefinition().setMeasureName(this.measure);
//	}
	
	
//	public static LifeStatus addMeasureName(LifeStatus p){
//		for (MeasureDefinition md : md.setMeasureName();
//			hp.setPerson(p);
//		}
//		return p;
//	}
